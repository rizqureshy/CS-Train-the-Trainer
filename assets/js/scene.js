...
export class Cosmos {
  ...
  /* ---------------- per-slide choreography ----------------
     Each formation echoes the slide's key message:
       0  title      — orb: the AI core, alive
       1  why        — core: the idea, dense and trapped, waiting
       2  survey     — split: dialogue — you said · we heard
       3  what it is — clusters(4): the four weeks
       4  rhythm     — ring: the weekly loop, always turning
       5  week 1     — orb (tight spin): the mind, rewiring
       6  week 2     — grid: the data lattice
